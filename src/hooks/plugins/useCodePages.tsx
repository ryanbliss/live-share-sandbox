...
export function useCodePages(codePagesMap: SharedMap | undefined): {
    ...
    const [pages, pagesRef, setPages] = useStateRef<Map<string, SharedStringHelper>>(new Map());
    const [files, filesRef, setFiles] = useStateRef<Map<string, string>>(new Map());
    ...
    const onTextChange = useCallback((event: ISharedStringHelperTextChangedEventArgs | undefined) => {
    ...
    useEffect(() => {
        function getHandleTextChangedCallback(): (event: ISharedStringHelperTextChangedEventArgs | undefined) => void {
            const handleTextChanged = (event: ISharedStringHelperTextChangedEventArgs | undefined) => {
